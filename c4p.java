...
b2  =new JButton("EXIT");
b1  =new JButton("OK!");
b3  =new JButton("Let it be");
b4  =new JButton("Oh! Darling");
b5  =new JButton("With a little help frow my friends");
b6  =new JButton("Baby it's you");
janela2  =new JFrame("The Beatles");
